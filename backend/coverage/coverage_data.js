window.SIMPLECOV_DATA = {
  ...
  "meta": {
    ...
    "project_name": "App",
    "timestamp": "2026-08-02T14:12:20.125+09:00",
    "root": "/app",
    "commit": null,
  ...
  "coverage": {
    ...
    "app/models/meal_record.rb": {
      "source": [
        ...
        "    if MealRecord.where(user_id: user_id, date: date).where.not(id: id).exists?",
        "      # 🔮 【日付自動連動の魔法！】",
    ...
    "app/models/weight_record.rb": {
      "source": [
        ...
        "  # 🔮 【体重側・日付自動連動の魔法！】",
        "  def date_uniqueness_without_english_prefix",
        "    if WeightRecord.where(user_id: user_id, date: date).where.not(id: id).exists?",
