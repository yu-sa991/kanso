// 🔐 frontend/src/components/Terms.jsx (正真正銘・全宇宙最終確定版のクリーンコード全文です！)
...
export default function Terms() {
  return (
    <div style={{ maxWidth: '600px', margin: '40px auto', padding: '30px', border: '1px solid #e2e8f0', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', background: 'white', fontFamily: 'sans-serif', textAlign: 'left', lineHeight: '1.7', color: '#2d3748' }}>
      ...
      <ul style={{ fontSize: '14px', marginLeft: '5px', paddingLeft: '20px', color: '#4a5568' }}>
        <li>1. サーバーやネットワークシステムに過度な負担をかける行為（ハッキングや嫌がらせ等）</li>
        <li>2. 本サービスの運営を妨害するおそれのある行為、または他のユーザーに不利益を与える行為</li>
        <li>3. その他、開発者が不適切と判断する一切の行為</li>
      </ul>
      <p style={{ fontSize: '14px', marginLeft: '5px', color: '#e53e3e', fontWeight: 'bold' }}>
        ※ユーザーが上記に違反した場合、開発者は事前の通知なく、即座に当該ユーザーのアカウントを削除（利用停止）できるものとします。
      </p>

      <h3 style={{ fontSize: '16px', marginTop: '25px', color: '#2c5282' }}>第4条（本サービスの提供の停止・変更等）</h3>
      <p style={{ fontSize: '14px', marginLeft: '5px' }}>
        開発者は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく、本サービスの全部または一部の提供を停止、または変更することができるものとします。
      </p>
      <ul style={{ fontSize: '14px', marginLeft: '5px', paddingLeft: '20px', color: '#4a5568' }}>
        <li>1. 本サービス用システムの保守点検、または更新を定期的一時的に行う場合</li>
        <li>2. 天災、火災、停電、通信回線の事故、または外部インフラ障害により、本サービスの提供が困難となった場合</li>
        <li>3. その他、開発者が本サービスの提供が困難と判断した場合</li>
      </ul>
      ...
      <p style={{ fontSize: '14px', marginLeft: '5px', background: '#fff5f5', padding: '12px', borderRadius: '8px', borderLeft: '4px solid #dc3545' }}>
        ...
        2. <strong>ユーザーが本サービスを利用したこと、または利用できなかったことによって生じた一切の損害（精神的苦痛、体調の変動、データの消失を含む一切の不利益等）について、当アプリおよび開発者は一切の責任を負いません。</strong>すべてユーザーご自身の自己責任においてご利用いただくものとします。
      </p>
